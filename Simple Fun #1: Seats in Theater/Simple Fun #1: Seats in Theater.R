...
# It's so bad you want to sneak out, which is quite simple, especially since the exit is located right behind your row to the 
...
seats_in_theater <- function(n_cols, n_rows, col, row) {
